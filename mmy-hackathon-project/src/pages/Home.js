    ...
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          right: 0,
          bottom: 0,
          background: 'radial-gradient(circle at center, transparent 0%, #f0f8ff 70%)',
          pointerEvents: 'none',
        }} />
        ...
        <div style={{ position: 'relative', maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <button style={{
              ...
              alignItems: 'center',
              gap: '0.75rem',
              boxShadow: '0 10px 20px rgba(59, 130, 246, 0.2), 0 6px 6px rgba(59, 130, 246, 0.1), 0 0 0 1px rgba(59, 130, 246, 0.1)',
              transition: 'all 0.3s ease',
              ':hover': {
                transform: 'translateY(-2px)',
                boxShadow: '0 20px 30px rgba(59, 130, 246, 0.3), 0 10px 10px rgba(59, 130, 246, 0.15), 0 0 0 2px rgba(59, 130, 246, 0.2)',
              }
            }}
            ...
            <button style={{
              ...
              ':hover': {
                ...
                borderColor: '#3B82F6',
                transform: 'translateY(-2px)',
                boxShadow: '0 8px 12px rgba(59, 130, 246, 0.1)',
              }
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            Join the Fight Against Alzheimer's with DemiSense.AI
          </h2>
          <p style={{
            ...
            Start using DemiSense.AI today and contribute to better outcomes for Alzheimer's patients.
