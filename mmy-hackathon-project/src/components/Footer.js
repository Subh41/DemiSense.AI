...
const Footer = () => {
  ...
  const footerStyle = {
    background: 'linear-gradient(135deg, rgba(240, 248, 255, 0.97), rgba(219, 234, 254, 0.97))',
      ...
      <div style={containerStyle}>
        <div style={gridStyle}>
          ...
          <div style={sectionStyle}>
            ...
            <a href="tel:+918910250019" style={linkStyle}>
              <Phone size={16} />
              <span>+91 8910250019</span>
            </a>
            <a href="mailto:subhojitdas0019@gmail.com" style={linkStyle}>
              <Mail size={16} />
              <span>subhojitdas0019@gmail.com</span>
            </a>
            <a href="mailto:arushi.ghosal@gmail.com" style={linkStyle}>
              <Mail size={16} />
              <span>arushi.ghosal@gmail.com</span>
            </a>
        ...
        <div style={copyrightStyle}>
          <p>© {new Date().getFullYear()} DemiSense.AI Platform. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
