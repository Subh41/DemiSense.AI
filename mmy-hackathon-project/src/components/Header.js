...
const Header = () => {
  ...
  const headerStyle = {
    ...
    boxShadow: scrolled 
      ? '0 4px 30px rgba(59, 130, 246, 0.08)'
      : 'none',
  ...
  const searchContainerStyle = {
    ...
    transition: 'all 300ms ease',
    boxShadow: '0 2px 4px rgba(52, 152, 219, 0.03)',
    ':hover': {
      backgroundColor: 'rgba(255, 255, 255, 0.95)',
      border: '1px solid #2e6da4',
      boxShadow: '0 4px 6px rgba(52, 152, 219, 0.05)'
    }
  };
  ...
  const profileButtonStyle = {
    ...
    boxShadow: isAuthenticated
      ? '0 4px 6px rgba(33, 150, 243, 0.15)'
      : '0 2px 4px rgba(33, 150, 243, 0.03)',
    ':hover': {
      backgroundColor: isAuthenticated 
  ...
  const profileImageStyle = {
    ...
    height: '36px',
    borderRadius: '50%',
    backgroundColor: isAuthenticated ? '#3498db' : 'rgba(255, 255, 255, 0.9)',
    display: 'flex',
    alignItems: 'center',
    ...
    boxShadow: '0 2px 4px rgba(52, 152, 219, 0.05)'
  };
  ...
  const profileDropdownStyle = {
    ...
    borderRadius: '1rem',
    boxShadow: '0 10px 30px rgba(0, 0, 0, 0.1), 0 4px 8px rgba(52, 152, 219, 0.05)',
        ...
        <nav style={navStyle}>
          <div style={navContentStyle}>
            ...
            >
              ...
              <span style={logoTextStyle}>DemiSense.AI</span>
            </Link>
            ...
            {navLinks.map((link) => (
              <Link
                ...
                style={{
                  ...
                  fontSize: '1rem',
                  fontWeight: '500',
                  color: activeLink === link.path ? '#3B82F6' : '#374151',
